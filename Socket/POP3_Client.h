...
public:
	...
	__declspec(dllexport) std::string extractHeaderValue(const std::string& emailContent, const std::string& header);
	__declspec(dllexport) std::string extractMimeContent(const std::string& emailContent);
	...
	__declspec(dllexport) std::tuple<bool, std::string> receiveEmail(std::vector<std::string>& sender, std::vector<std::string>& recipient, std::vector<std::string>& subject, std::vector<std::string>& content);
};